...
The assignment specifically includes sections for data filtering and grouping.
...
![Top 3 Customers by Spending](images/top-3-customers-by-total-spending.png)
...
│
├── images/
│   ├── total-purchase-by-city.png
│   ├── purchase-share-by-gender.png
│   ├── top-3-customers-by-spending.png
